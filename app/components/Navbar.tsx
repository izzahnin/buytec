...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between px-[32px] py-[16px] shadow-lg lg:px-[56px]">
      ...
      {/* category */}
      <section className="hidden flex-row gap-8 lg:flex">
        <p className="hover:cursor-pointer">Notes</p>
        <p className="hover:cursor-pointer">Brand</p>
        <p className="hover:cursor-pointer">Occasion</p>
        <p className="hover:cursor-pointer">Gender</p>
        <p className="hover:cursor-pointer">Concentration</p>
        <p className="hover:cursor-pointer">Size</p>
        <p className="hover:cursor-pointer">Origin</p>
      </section>
      {/* leading desktop */}
